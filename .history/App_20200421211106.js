    ...
    return (
      <View style={styles.container}>
        ...
        <NavigationContainer ref={containerRef} initialState={initialNavigationState}>
          <Stack.Navigator>
            <Stack.Screen screenOptions={{ headerShown: false }} name="Signin" component={Signin} />
            <Stack.Screen screenOptions={{ headerShown: false }} name="Signup" component={Signup} />
            <Stack.Screen screenOptions={{ headerShown: false  }} name="ForgotPassword" component={ForgotPassword} />
            <Stack.Screen screenOptions={{ headerShown: true }} name="Main" component={BottomTabNavigator} />
          </Stack.Navigator>
        </NavigationContainer>
      </View>
    );
