          ...
          <View style={styles.subSection}>
            <MonoText style={styles.mutedText}>Top Savers</MonoText>
              ...
              <View style={styles.savers}>
                ...
                />
                <MonoText style={styles.saversText}>French Fries Originally from Italy but commonly known as French fries</MonoText>
                <MonoText style={styles.saversText}></MonoText>
              </View>
