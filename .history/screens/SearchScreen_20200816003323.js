...
export default class SearchScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <SearchBar
                    placeholder="Search" lightTheme={true} inputStyle={{ fontFamily: 'muli-regular', fontSize: 10, }}
                    containerStyle={{backgroundColor: '#fbfbfb', borderWidth: 0, borderColor: '#fbfbfb', fontFamily: 'muli-regular', fontSize: 10, }}
                    onChangeText={this.updateSearch} inputContainerStyle={{backgroundColor: '#e5e4ea', borderRadius: 30, fontFamily: 'muli-regular', fontSize: 10, }}
                    value={search}
                />
