...
export default class SearchScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <SearchBar
                    placeholder="Search" lightTheme={true} inputStyle={{ fontFamily: 'muli-regular', fontSize: 18, marginTop: -10 , marginBottom: -10}}
                    containerStyle={{ backgroundColor: '#fbfbfb', borderWidth: 0, borderColor: '#fbfbfb', paddingTop: 20 }}
