            ...
            <ScrollView contentContainerStyle={styles.contentContainer}>
                ...
                <View style={styles.fields}>
                    ...
                    <View style={styles.bottomView}>
                        <Text style={styles.bottomLinks} onPress={() => {navigation.navigate('Signup', {name: 'Jane'})}}>Don't have an account?</Text>
                        <Text style={styles.bottomLinks}>Forgot password?</Text>
                    </View>
