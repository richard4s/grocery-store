...
import { Image, Platform, StyleSheet, Text, TouchableOpacity, View, ImageBackground, TextInput, Button } from 'react-native';
        ...
        <ImageBackground source={bg} style={styles.imgContainer}>
            ...
            <ScrollView contentContainerStyle={styles.contentContainer}>
                ...
                <View style={styles.fields}>
                    ...
                    <Button style={styles.authButton} onPress={() => alert('signed in')}>
