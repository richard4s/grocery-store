...
export default class SearchScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <SearchBar
                    placeholder="Search" lightTheme={true} inputStyle={{ fontFamily: 'muli-regular', fontSize: 18, paddingTop: -50 , marginBottom: -50}}
                    containerStyle={{ backgroundColor: '#fbfbfb', borderWidth: 0, borderColor: '#fbfbfb' }}
                    onChangeText={this.updateSearch} inputContainerStyle={{ backgroundColor: '#e5e4ea', borderRadius: 30, paddingTop: -70 }}
                    value={search}
                />
